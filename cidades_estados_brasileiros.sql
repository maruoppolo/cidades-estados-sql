--
-- SQL com todos os municipios e estados brasileiros
-- Oferecido por Marcello Ruoppolo https://marcellodev.com | hello@marcellodev.com
--
CREATE TABLE `cities` (
...
CREATE TABLE `states` (
  ...
  `state_uf` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `states` (`state_id`, `state_name`, `state_uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
